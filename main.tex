...
\begin{figure}
\includegraphics[width=\maxwidth{\textwidth}]{TSNE.png}
...
\begin{figure}
\includegraphics[width=\maxwidth{\textwidth}]{PCA.png}
\caption{t-Distributed Nearest Neighbour Spatial Embedding}
\label{figure\arabic{figurecounter}}
\legend{ Three types of feature extraction}

%\emph{Note}: Allen Brain SDK, Human Brain Feature Ephysiological Feature Extraction Library.}
...
%[width=0.5\textwidth]
%\maxwidth=0.9
\includegraphics[width=\maxwidth{\textwidth},scale=0.5]{PCA.png}
...
\include{Optimization_of_existing_models_to_align_them_with_data.tex}\include{Optimization_of_models_to_find_diverse_solutions_for_the_same_behaviors.tex}        
\include{Technical_details_of_optimizer.tex}
